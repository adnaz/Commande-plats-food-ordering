...
@section('head_title', 'Modifier Profile' .' | '.getcong('site_name') )
  ...
  <div class="row">
    ...
    <div class="col-md-6">
        <div class="box_style_2" id="order_process">
          <h2 class="inner">Modifier Profile</h2>
        ...
        @endif
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <textarea class="form-control" style="height:150px" placeholder="Adresse" name="address" id="address">{{$user->address}}</textarea>
            </div>
          </div>
