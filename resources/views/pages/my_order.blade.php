...
@section('head_title', 'Ma commande' .' | '.getcong('site_name') )
...
<div class="sub-banner" style="background:url({{ URL::asset('upload/'.getcong('page_bg_image')) }}) no-repeat center top;">
 ...
 <div class="white_for_login">
    <div class="container margin_60">
      ...
      <h2 class="inner">liste de commande</h2>
      ...
      <tbody>
        ...
        @foreach($order_list as $order_item)
                ...
                @if($order_item->status!='Annuler' and $order_item->status!='Completer')

                <td><a href="{{URL::to('cancel_order/'.$order_item->id)}}" class=""><strong>Annuler</strong></a></td>
                @else
