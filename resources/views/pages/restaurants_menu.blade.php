    ...
    <div class="col-md-10 col-sm-9">  
      ...
      <div class="rating"> 
         @for($x = 0; $x < 5; $x++)
                ...
                @endfor 
                (<small><a href="{{URL::to('restaurants/'.$restaurant->restaurant_slug)}}"> montrer {{\App\Review::getTotalReview($restaurant->id)}} Reviews </a></small>)
      </div>
      <div class="rstl_list_btn"><a href="{{URL::to('restaurants/'.$restaurant->restaurant_slug)}}">Voir le restaurant</a></div>
      </div>
    </div>
      </div>
    </div>
  ...
  <div class="restaurant_list_detail">
    <div class="container">
      ...
      <div id="main_menu" class="box_style_2">
        <h2 class="inner">Liste de menu</h2>
