<div id="banner">
  ...
  <div id="subheader">
    <div id="sub_content" class="animated zoomIn">
      <h1>Commandez des plats délicieux en ligne!</h1>
      <div class="container-4">
        {!! Form::open(array('url' => 'restaurants/search','class'=>'','id'=>'search','role'=>'form')) !!} 
          <input type="search" placeholder="Restaurant" name="search_keyword" id="search">
  ...
  <div class="hidden-xs" id="count">
    <ul>
      <li><span class="number">{{getcong('total_restaurant')}}</span> Restaurants</li>
      <li><span class="number">{{getcong('total_people_served')}}</span> Personnes servies</li>
      <li><span class="number">{{getcong('total_registered_users')}}</span> Utilisateurs enregistrés</li>
    </ul>
  </div>
  </section>
