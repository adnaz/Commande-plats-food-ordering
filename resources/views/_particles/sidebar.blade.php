<div class="col-md-3 col-sm-5 col-xs-12 side-bar">   
      ...
      <div id="cart_box">
      <h3>VOTRE COMMANDE <i class="fa fa-shopping-cart pull-right"></i></h3>
      ...
      <hr>
          <a class="btn_full" href="{{URL::to('order_details')}}">Commandez maintenant</a>  
          @else
            <a class="btn_full" href="#0">panier vide</a>  
          @endif
    </div>  
        ...
        <div id="cart_box" class="categories">
            ...
            <ul>
             <li>
                <label><a href="{{URL::to('restaurants/')}}">tous</a></label>
              </li>
