...
<p style="padding:0 10px;margin: 0 0 10px;line-height:22px;color:#444">Merci pour VOTRE COMMANDE!</p> 
	...
	<table height="100%" width="100%">
	  <thead>
		<tr style="border-bottom:1px solid #ccc">                      
		  ...
		  <th style="width:12%;color:#565656;text-align:left;padding:10px;vertical-align: middle;">Qté</th>
		  <th style="width:12%;color:#565656;text-align:left;padding:10px;vertical-align: middle;">peix</th>
		  <th style="width:38%;color:#565656;text-align:left;padding:10px;vertical-align: middle;">total</th>
		</tr>
	  </thead>
	  <div style="clear:both"></div>
	  <tbody>
		...
		<tr style="border-bottom:1px solid #ccc">                      
		  ...
		  <td style="width:12%;color:#565656;text-align:left;padding:10px;vertical-align: middle;">&nbsp;</td>
		  <td style="width:38%;color:#565656;text-align:left;padding:10px;vertical-align: middle;"><b>Montant payable:$ {{$sum}}</b>
		  </td>
		</tr>							
	  </tbody>				  
	</table>
