            ...
            <tr>
                ...
                <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right" role="menu"> 
                                    <li><a href="{{ url('admin/restaurants/view/'.$restaurant_id.'/orderlist/'.$order->id.'/En attente') }}"><i class="md md-lock"></i> en attente</a></li>
                                    <li><a href="{{ url('admin/restaurants/view/'.$restaurant_id.'/orderlist/'.$order->id.'/En traitement') }}"><i class="md md-loop"></i> En traitement</a></li>
                                    <li><a href="{{ url('admin/restaurants/view/'.$restaurant_id.'/orderlist/'.$order->id.'/Completer') }}"><i class="md md-done"></i> Completer</a></li>
                                    <li><a href="{{ url('admin/restaurants/view/'.$restaurant_id.'/orderlist/'.$order->id.'/Annuler') }}"><i class="md md-cancel"></i> Annuler</a></li>
                                    <li><a href="{{ url('admin/restaurants/view/'.$restaurant_id.'/orderlist/'.$order->id) }}"><i class="md md-delete"></i> Supprimer</a></li>
                                </ul>                                                                                                                                                      
                            </div> 
