...
<span aria-hidden="true">&times;</span></button>
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li role="presentation">
            <a href="#about_widget" aria-controls="about_widget" role="tab" data-toggle="tab">À PROPOS DE NOUS Page</a>
        </li>        
        <li role="presentation">
    ...
    <div class="tab-content tab-content-default">
        <div role="tabpanel" class="tab-pane active" id="footer_widgets">             
            {!! Form::open(array('url' => 'admin/footer_widgets','class'=>'form-horizontal padding-15','name'=>'about_contact_widgets_form','id'=>'about_contact_widgets_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Widget 3 Adresse</label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Widget 3 téléphone</label>
                    <div class="col-sm-9">
