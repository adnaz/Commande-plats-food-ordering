    ...
    <div class="tab-content tab-content-default">
            ...
            {!! Form::open(array('url' => 'admin/settings','class'=>'form-horizontal padding-15','name'=>'account_form','id'=>'account_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
                ...
                <div class="form-group">
                    <div class="col-md-offset-3 col-sm-9 ">
                    	<button type="submit" class="btn btn-primary">Sauvegarder les modifications <i class="md md-lock-open"></i></button>
        ...
        <div role="tabpanel" class="tab-pane" id="homepage_settings">             
            {!! Form::open(array('url' => 'admin/homepage_settings','class'=>'form-horizontal padding-15','name'=>'layout_settings_form','id'=>'layout_settings_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Nombre total de restaurants</label>
                    <div class="col-sm-9">
                        <input type="text" name="total_restaurant" value="{{ $settings->total_restaurant }}" class="form-control" value="">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Nombre total de personnes desservies</label>
                    <div class="col-sm-9">
                        <input type="text" name="total_people_served" value="{{ $settings->total_people_served }}" class="form-control" value="">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Nombre total d'utilisateurs enregistrés</label>
                    <div class="col-sm-9">
        ...
        <div role="tabpanel" class="tab-pane" id="other_Settings">
            ...
            {!! Form::open(array('url' => 'admin/headfootupdate','class'=>'form-horizontal padding-15','name'=>'pass_form','id'=>'pass_form','role'=>'form')) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea type="text" name="site_header_code" class="form-control" rows="5" placeholder="You may want to Ajouter some html/css/js code to header. ">{{ $settings->site_header_code }}</textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Footer Code</label>
                    <div class="col-sm-9">
                        <textarea type="text" name="site_footer_code" class="form-control" rows="5" placeholder="You may want to Ajouter some html/css/js code to footer. ">{{ $settings->site_footer_code }}</textarea>
                    </div>
                </div>
