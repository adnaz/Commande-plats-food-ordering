...
<div id="main">
	<div class="page-header">
		<h2> {{ isset($user->id) ? 'Modifier: User' : 'Ajouter User' }}</h2>
            ...
            <div class="panel-body">
                    ...
                    <div class="col-sm-4">
                        <select id="basic" name="usertype" class="selectpicker show-tick form-control">
                               @if(isset($user->usertype))  
                                    <option value="Owner" @if($user->usertype=='Owner') selected @endif >propriétaire</option>
                                    <option value="User" @if($user->usertype=='User') selected @endif >utilistaur</option>
                ...
                <div class="form-group">
                    <div class="col-md-offset-3 col-sm-9 ">
                    	<button type="submit" class="btn btn-primary">{{ isset($user->name) ? 'Modifier User ' : 'Ajouter User' }}</button>
