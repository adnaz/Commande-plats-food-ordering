...
<div id="main">
	<div class="page-header">
		<h2> {{ isset($cat->category_name) ? 'Modifier: '. $cat->category_name : 'Ajouter Catégorie' }}</h2>
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <div class="col-md-offset-3 col-sm-9 ">
                    	<button type="submit" class="btn btn-primary">{{ isset($cat->id) ? 'Modifier Catégorie ' : 'Ajouter Catégorie' }}</button>
