...
<div id="main">
	<div class="page-header">
		<h2> {{ isset($menu->menu_name) ? 'Modifier: '. $menu->menu_name : 'Ajouter Menu' }}</h2>
   	...
   	<div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Menu Catégorie</label>
                    <div class="col-sm-4">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Prix</label>
                      <div class="col-sm-9">
                ...
                <div class="form-group">
                    <div class="col-md-offset-3 col-sm-9 ">
                    	<button type="submit" class="btn btn-primary">{{ isset($menu->id) ? 'Modifier Menu ' : 'Ajouter Menu' }}</button>
