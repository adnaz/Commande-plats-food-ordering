		...
		<div class="wrapper" style="margin-bottom:90px">
			<ul class="nav nav-sidebar" id="sidebar-menu">
                	...
                	@if(Auth::user()->usertype=='Admin')
               		...
               		<li class="{{classActivePath('types')}}"><a href="{{ URL::to('admin/types') }}"><i class="fa fa-tags"></i>Types Restaurant</a></li>

               		<li class="{{classActivePath('restaurants')}}"><a href="{{ URL::to('admin/restaurants') }}"><i class="fa fa-cutlery"></i>Restaurants</a></li>

               		<li class="{{classActivePath('allorder')}}"><a href="{{ URL::to('admin/allorder') }}"><i class="fa fa-cart-plus"></i>liste de commande</a></li>
	                
	                <li class="{{classActivePath('users')}}"><a href="{{ URL::to('admin/users') }}"><i class="fa fa-users"></i>utilisateurs</a></li>
               	 ...
               	 @else
               		...
               		<li class="{{classActivePath('restaurants')}}"><a href="{{ URL::to('admin/myrestaurants') }}"><i class="fa fa-cutlery"></i>Mon Restaurants</a></li>
               		...
               		<li class="{{classActivePath('orderlist')}}"><a href="{{ URL::to('admin/orderlist') }}"><i class="fa fa-cart-plus"></i>liste de commande</a></li>
  ...
  <div class="sidebar right-side" id="sidebar-right">
	...
	<div class="nicescroll">
		<div class="wrapper">
			...
			<ul class="nav nav-sidebar" id="sidebar-menu">
				<li><a href="{{ URL::to('admin/profile') }}"><i class="md md-person-outline"></i> Compte</a></li>				 
				...
				<li><a href="{{ URL::to('admin/logout') }}"><i class="md md-exit-to-app"></i> se déconnecter</a></li>
			</ul>
		</div>
	</div>
</div>
