...
class IndexController extends Controller
{
    ...
    public function postLogin(Request $request)
    {
        ...
        // return array("errors" => 'email ou le mot de passe est invalide. Veuillez réessayer.');
        //return redirect('/admin');
        return redirect('/login')->withErrors('email ou le mot de passe est invalide. Veuillez réessayer.');
    }
    ...
    public function logout()
    {
        ...
        \Session::flash('flash_message', 'Déconnexion réussie ...');
    ...
    public function editprofile(Request $request)
    {
        ...
        \Session::flash('flash_message', 'Changements sauvegardés');
    ...
    public function edit_password(Request $request)
    {
        ...
        \Session::flash('flash_message', 'Password a été modifier...');
