...
class CategoriesController extends MainAdminController
{
    ...
    public function addnew(Request $request)
    {
        ...
        if (!empty($inputs['id'])) {
            ...
            \Session::flash('flash_message', 'Ajouter');
    ...
    public function delete($cat_id)
    {
        if (Auth::User()->usertype == "Admin" or Auth::User()->usertype == "Owner") {
            ...
            \Session::flash('flash_message', 'suprimmer');
    ...
    public function owner_addeditCategory()
    {
        ...
        if (Auth::User()->usertype != "Owner") {
            ...
            \Session::flash('flash_message', 'Accée refuser!');
        ...
        if ($restaurant_id == "") {
            ...
            \Session::flash('flash_message', 'ajouter Restaurant');
