...
class CartController extends Controller
{
    ...
    public function confirm_order_details(Request $request)
    {
        ...
        //$order_list = Order::where(array('user_id'=>$user_id,'status'=>'en attente'))->orderBy('item_name','desc')->get();
        ...
        $subject = getcong('site_name') . ' Commande confirmée';
        ...
        $subject2 = 'Nouvelle commande passée';
    ...
    public function cancel_order($order_id)
    {
        ...
        \Session::flash('flash_message', 'Commande a été annulée');
